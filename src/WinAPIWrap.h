...
class MyUnknownPtr
{
 ...
 public:
   IUnknown **getPointerToPointerToNull()
   {
      release();
      return &pUnknown;
   }
...
class IMMDeviceEnumeratorPtr : public MyUnknownPtr
{
 ...
 public:
   ...
   IMMDeviceEnumeratorPtr &operator=(const IMMDeviceEnumeratorPtr &rhs)
   {
      MyUnknownPtr::operator=(rhs);
      return *this;
   }
   IMMDeviceEnumeratorPtr &operator=(IMMDeviceEnumerator *rawRhs)
   {
      MyUnknownPtr::operator=(rawRhs);
      return *this;
   }

   IMMDeviceEnumerator *operator->()
   {
      auto pEnum = getEnumerator();
      if (pEnum)
         return pEnum;
      else
         return &dummyEnum;
...
class IMMDeviceCollectionPtr : public MyUnknownPtr
{
 ...
 public:
   ...
   IMMDeviceCollectionPtr &operator=(const IMMDeviceCollectionPtr &rhs)
   {
      MyUnknownPtr::operator=(rhs);
      return *this;
   }
   IMMDeviceCollectionPtr &operator=(IMMDeviceCollection *rawRhs)
   {
      MyUnknownPtr::operator=(rawRhs);
      return *this;
   }

   IMMDeviceCollection *operator->()
   {
...
class IMMDevicePtr : public MyUnknownPtr
{
 ...
 public:
   ...
   IMMDevicePtr &operator=(const IMMDevicePtr &rhs)
   {
      MyUnknownPtr::operator=(rhs);
      return *this;
   }
   IMMDevicePtr &operator=(IMMDevice *rawRhs)
   {
      MyUnknownPtr::operator=(rawRhs);
      return *this;
   }
...
class IPropertyStorePtr : public MyUnknownPtr
{
 ...
 public:
   ...
   IPropertyStorePtr &operator=(const IPropertyStorePtr &rhs)
   {
      MyUnknownPtr::operator=(rhs);
      return *this;
   }
   IPropertyStorePtr &operator=(IPropertyStore *rawRhs)
   {
      MyUnknownPtr::operator=(rawRhs);
      return *this;
   }

   IPropertyStore *operator->()
   {
      auto pStore = getPropertyStore();
      if (pStore)
         return pStore;
      else
         return &dummyPropertyStore;
   }
};
...
class IAudioEndpointVolumePtr : public MyUnknownPtr
{
 ...
 public:
   ...
   IAudioEndpointVolumePtr &operator=(const IAudioEndpointVolumePtr &rhs)
   {
      MyUnknownPtr::operator=(rhs);
      return *this;
   }
   IAudioEndpointVolumePtr &operator=(IAudioEndpointVolume *rawRhs)
   {
      MyUnknownPtr::operator=(rawRhs);
      return *this;
   }

   IAudioEndpointVolume *operator->()
   {
...
class InjectionFramework
{
 ...
 public:
   ...
   static void initTests(IMMDeviceEnumerator *pTestEnumerator)
   {
      runningTests = true;
      pEnum = pTestEnumerator;
      initCount = 0;
   }
