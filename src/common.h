...
namespace MockCom
   {
      ...
      public:
         ...
         virtual HRESULT QueryInterface(const IID &riid, void ** ppvObject) { *ppvObject = NULL; return E_NOTIMPL; }
         virtual HRESULT EnumAudioEndpoints(EDataFlow dataFlow, DWORD dwStateMask, IMMDeviceCollection **ppDevices) { *ppDevices = NULL; return E_NOTIMPL; }
         virtual HRESULT GetDefaultAudioEndpoint(EDataFlow dataFlow, ERole role, IMMDevice **ppEndpoint) { *ppEndpoint = NULL; return E_NOTIMPL; }
         virtual HRESULT GetDevice(LPCWSTR pwstrId, IMMDevice **ppDevice) { *ppDevice = NULL; return E_NOTIMPL; }
      ...
      public:
         ...
         virtual HRESULT Item(UINT nDevice, IMMDevice **ppDevice) { *ppDevice = NULL; return E_NOTIMPL; }
      };
      ...
      public:
         ...
         virtual ULONG Release() { return -1; }
         virtual HRESULT QueryInterface(const IID &riid, void ** ppvObject) { *ppvObject = NULL; return E_NOTIMPL; }
         virtual HRESULT Activate(REFIID iid, DWORD dwClsCtx, PROPVARIANT *pActivationParams, void **ppInterface) { *ppInterface = NULL; return E_NOTIMPL; }
         virtual HRESULT OpenPropertyStore(DWORD stgmAccess, IPropertyStore **ppProperties) { *ppProperties = NULL; return E_NOTIMPL; }
